...
| [Strategic](#strategic) | [**EML**](https://github.com/db1group/engineering-performance-guide/tree/main/indicators/strategic/EML.md)           | Engineering Maturity Level          | This indicator measures the average engineering maturity level of projects, using the following criteria:<br>3- Optimal;<br>2- Managed;<br>1- Standard;<br>0- Unmapped/Chaos. |
